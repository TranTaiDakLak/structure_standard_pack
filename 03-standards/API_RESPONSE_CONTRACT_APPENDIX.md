...
**Test e2e bắt buộc:** cố ý gây panic rồi assert body không chứa chuỗi nào của stack trace. Không có test này thì rule "không rò stack trace" chỉ là lời khuyên.
